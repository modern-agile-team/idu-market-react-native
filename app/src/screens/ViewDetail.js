...
const Item = React.memo(
  ...
  return (
    <ItemContainer onPress={() => onPress({ id, title })}>
      ...
      <ItemRowContainer>
          <ItemComment><Text>답글쓰기</Text></ItemComment>
      </ItemRowContainer>
    </ItemContainer>
  );
}
        ...
        >
            <Container>
              ...
              <PostRowContainer>
                ...
                <PostModify ><Text style={{ color:"#fff" }}>수정</Text></PostModify>
                <PostRemove 
                    onPress={_handlRemoveBtnPress}
                >
                    <Text style={{ color:"#fff" }}>삭제</Text>
                </PostRemove>
              </PostRowContainer>
              <PostContent>내용은 길고 험하지 asdasdasdsdfsdㅁㄴㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇSDFJSDFJSFSFㄴㅇ론ㅇ런ㅇ런ㅇ런ㅇ런언ㅇ러
              </PostContent>
              <CommentContainer>
                <CommentTitle>
                    댓글
